package appPackage;
//THIS IS THE PAGE ADDED AS TAB IN ADMIN LOGIN AND IS USED WHEN THE ADMIN WANTS TO CHANGE PASSWORD
...
public class AdminChangePass extends JPanel
{
	JLabel l1;
	JPasswordField p1;
	JButton b1;
	String oldpass1;
	public AdminChangePass(String oldpass, String uid)
	{
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{	
					try
					{
						...
						String query = "update admindata set password = ? where password = ? and id = ?";
