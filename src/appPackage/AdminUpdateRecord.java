...
//THIS PAGE IS ADDED AS TAB IN THE ADMIN LOGIN AND IS USED WHEN THE ADMIN WANTS TO CHANGE HIS PERSONAL INFO

public class AdminUpdateRecord extends JPanel
{
	JPanel panel1,panel2;
	JButton b1,b2,b3,b4,b5,b6;
	JTextField field;
	public AdminUpdateRecord(String pass, String uid) //the parameter is the password of the administrator
	{
	...
	public void updateRecord(String oldpass , String userId ,String field ,String newVal)
	{
		...
		{
			String query = "update admindata set "+field+" = "+"\""+newVal+"\""+" where password = "+"\""+oldpass+"\""+" and id = "+"\""+userId+"\"";
			try
			{
